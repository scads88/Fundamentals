...
#there is the possibility of accessing stuff in soup through different way
###more sentex related than the stackoverflow method using select ive been using
## to this point
...
#t2=[e.get_text() for e in soup3.select(".rowTitle")] #soup perused and labels and ratios extracted and fed into vbls based upon html characteristics
#t3=fundamentalratiolabels=[e.get_text() for e in soup3.select(".valueCell")] #soup perused and labels and ratios extracted and fed into vbls based upon html characteristics
# =============================================================================
# 
